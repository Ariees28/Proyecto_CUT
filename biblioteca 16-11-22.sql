...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-11-2022 a las 06:19:13
...
(43, 'Administración', 'Administracion.jpg', 'La administración es el proceso que busca por medio de la planificación, la organización, ejecución y el control de los recursos darles un uso más eficiente para alcanzar los objetivos de una institución'),
...
(62, 'JORGEARIEES', '$argon2i$v=19$m=2048,t=4,p=3$akI1Lmh3TlZ5Z3VseFNFaQ$PadEy7t9u9Ajo/JwxOqt8UlEPg7PJeeg9VBFiFLgDbI', 'ARIEESRODRIGUEZ', 'correo1@hotmail.com', '0', '', 0, 0, ''),
(68, 'LECTOR', '$argon2i$v=19$m=2048,t=4,p=3$VHE5Mlppc0ViQXVTN2ViTg$1D7KexM163gvlq20Dw7BZ7vZSPZLrKs6GAMAec4cSxs', 'LECTOR', 'lector@hotmail.com', 'Lector', '7d9d7b05eff0b5b2679c3f985b21487c', 1, 0, '');
