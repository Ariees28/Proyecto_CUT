                    ...
                    <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                        ...
                        <div class="card-body row">
                          <div class="col-md-6">
                            ...
                            <input type="email" id="emailRec" class="form-control">
                          </div>
                          <div class="col-md-6"></div>
                          <div class="divider"></div>
                          <div class="col-md-6" id="divsvmt">
                            <button type="button" class="btn btn-primary btn-lg" id="sbmt">Enviar correo de recuperación</button>
                          </div>
...
<script src="../js/creados/solicNuevContra.js"></script>