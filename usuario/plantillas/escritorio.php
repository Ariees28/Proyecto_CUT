...
<div class="app-page-title">
    ...
    <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
        <li class="nav-item">
            <a role="tab" class="nav-link active" onclick="cargarcontenido('ContenedorPrincipal','escritorio.php')">
                <span>Variation 1</span>
            </a>
        </li>
        <li class="nav-item">
            <a role="tab" class="nav-link" onclick="cargarcontenido('ContenedorPrincipal','analytics-variation.php')"> 
