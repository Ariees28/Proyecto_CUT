...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-11-2022 a las 19:58:05
...
INSERT INTO `genero` (`id`, `genero`, `imagen`, `descripcion`, `tipoPrestamos`) VALUES
(31, 'Literatura y Novelas', 'literaturaYnovelas.jpg', 'La novela es la obra por excelencia del género narrativo y se distingue por su extensión y profundidad en torno al desarrollo de situaciones, personajes y el uso de recursos literarios.', 1),
(32, 'Arte', 'Arte.jpg', 'El arte es toda forma de expresión de carácter creativo que poseen los seres humanos. Es la capacidad que tiene el hombre para representar sus sentimientos, emociones y percepciones acerca de sus vivencias y el entorno que lo rodea.', 0),
(33, 'Arquitectura', 'Arquitectura.jpg', 'La arquitectura es el arte y la técnica de concebir, diseñar y construir edificaciones que funcionen como hábitat para el ser humano, ya sean viviendas, lugares de trabajo, de recreación o memoriales.', 0),
(34, 'Cine', 'Cine.jpg', 'En la carrera de Cine se forman los profesionales de la realización cinematográfica, quienes plasman sus conocimientos y su sensibilidad en trabajos de animación, de ficción, documentales, entre otros, gracias a los cuales despiertan un sinfín de sentimientos y hasta conciencia en la sociedad.  ', 0),
(35, 'Diseño', 'Disenio.png', 'La palabra diseño tiene un rango muy amplio de definiciones, ya que se aplica a muchas áreas del saber humano de manera más o menos diferenciada. Sin embargo, por diseño nos referimos generalmente a un proceso de prefiguración mental, es decir, de planificación creativa, en el que se persigue la solución para algún problema concreto, especialmente en el contexto de la ingeniería, la industria, la arquitectura, la comunicación y otras disciplinas afines.', 0),
(36, 'Fotografía', 'Fotografia.jpg', 'Se llama fotografía a una técnica y a una forma de arte que consisten en capturar imágenes empleando para ello la luz, proyectándola y fijándola en forma de imágenes sobre un medio sensible (físico o digital).', 0),
(37, 'Musica y Danza', 'musicaydanza.jpg', 'La danza o el baile es un arte donde se utiliza el movimiento de las partes del cuerpo generalmente con música, como una forma de expresión y de interacción social con fines de entretenimiento, artísticos o religiosos.', 0),
(38, 'Novela gráfica', 'novelagrafica.jpg', 'La novela gráfica es un tipo de publicación que fusiona los formatos del cómic y la novela tradicional, tomando elementos de los dos géneros. La misma cuenta una historia mediante viñetas que contienen ilustraciones y textos pero, a diferencia de las historietas tradicionales, está dirigida a un público más adulto y el relato tiene tintes literarios.', 1),
(39, 'Cuerpo, Alma y Espíritu', 'cuerpoAlmayEspiritu.jpg', 'Estudios sobre la espiritualidad, el estudio del alma, la mente y el cuerpo como tres partes de uno solo.', 1),
(40, 'Religión y espiritualidad', 'rel.jpg', 'La religión puede definirse como “creencia en Dios o dioses para ser adorados, usualmente expresado en conducta y ritual” o “cualquier sistema específico de creencia, adoración, etc., que regularmente incluye un código de ética”. La espiritualidad puede definirse como “la cualidad o hecho de ser espiritual, no-físico” o “un carácter predominantemente espiritual demostrado por el pensamiento, vida, etc.; tendencia o tono espiritual”.', 1),
(41, 'Salud y ejercicio', 'Salud y ejercicio.jpg', 'El ejercicio es la actividad física planificada, estructurada y repetitiva, realizada para mantener o mejorar una forma física, empleando un conjunto de movimientos corporales que se realizan para tal fin. Por consiguiente, se considera ejercicio al conjunto de acciones motoras musculo-esqueléticas.', 0),
(42, 'Negocios y Finanzas', 'Negocios y Finanzas.jpg', 'Son el arte y la ciencia de administrar dinero. Personal: Afectan en las decisiones de cuánto dinero gastar, cuanto ahorrar y como invertir ahorro. Empresa: Implica en las decisiones como incrementar el dinero de los inversores, invertir dinero, reinvertir ganancia', 0),
(43, 'Administración', 'Administracion.jpg', 'La administración es el proceso que busca por medio de la planificación, la organización, ejecución y el control de los recursos darles un uso más eficiente para alcanzar los objetivos de una institución', 0),
(44, 'Ciencia y Naturaleza', 'Ciencia y Naturaleza.jpg', 'La ciencia es un disciplina que se encarga de estudiar e investigar con rigor los fenómenos sociales, naturales y artificiales a través de la observación, experimentación y medición para dar respuesta a lo desconocido.', 0),
(45, 'Mercadotecnia', 'mercadotecnia.jpg', 'La mercadotecnia es un conjunto de actividades que se realizan para identificar las necesidades de un público determinado con el objeto de brindarle productos o servicios para satisfacerlos de la forma más adecuada.', 0),
(46, 'Comunicación', 'Comunicacion.jpg', 'La comunicación estudia el intercambio de ideas y mensajes que presuponen una participación generada entre diferentes grupos sociales y culturas. La comunicación como materia de estudio tiene el fin de crear mensajes claros y con un significado para quienes esté dirigido, el mensaje puede ser creado con fines de entretenimiento, informativo, lucrativo etc.', 0),
(47, 'Medicina', 'medicinaG.jpg', 'Medicina es la \'ciencia de la sanación\' o práctica del diagnóstico, tratamiento y prevención de alguna enfermedad, infección o dolencia. Medicina también es sinónimo de medicamento o remedio.', 0),
(48, 'Derecho', 'derechoG.jpg', 'El derecho es el conjunto de principios y normas, generalmente inspirados en ideas de justicia y orden, que regula las relaciones humanas en toda sociedad y cuya observancia puede ser impuesta de forma coactiva por parte de un poder público.', 0),
(49, 'Matemáticas', 'matematicas.jpg', 'Las matemáticas son una ciencia formal, que estudia la relación entre entes o elementos abstractos, como son los números, los signos y las figuras', 0),
(50, 'Algebra', 'algebra.jpg', 'El álgebra es una de las principales ramas de las matemáticas. Su objeto de estudio son estructuras abstractas operando en patrones fijos, dentro de las cuales suele haber más que números y operaciones aritméticas: también letras, que representan operaciones concretas, variables, incógnitas o coeficientes.', 0),
(51, 'Pedagogía', 'pedagogia.png', 'La pedagogía es la ciencia que estudia la educación. El objeto principal de su estudio es la educación como un fenómeno socio-cultural, por lo que existen conocimientos de otras ciencias que ayudan a comprender el concepto de educación, como por ejemplo, la historia, la psicología, la sociología, etc.', 0),
(52, 'Psicología', 'psicologia.jpg', 'La psicología es una ciencia social y una disciplina académica enfocadas en el análisis y la comprensión de la conducta humana y de los procesos mentalesexperimentados por individuos y por grupos sociales durante momentos y situaciones determinadas.', 0),
(53, 'Filosofía', 'filosofia.jpg', 'Filosofía es un conjunto de razonamientos lógicos y metódicos sobre conceptos abstractos que tratan de explicar las causas y fines de la verdad, la realidad, las experiencias y nuestra existencia.', 0),
(54, 'Física', 'fisica.jpg', 'Es considerada una ciencia pura y natural debido a que se encarga de estudiar no solo el tiempo y el espacio, sino también la energía y la materia. Esto se puede ver en física o química, pero al final, es la física pura en la que se hallan las respuestas adecuadas para las incógnitas referentes al universo.', 0),
(55, 'Química', 'quimica.jpg', 'La química Es una ciencia que se encarga de analizar la composición, propiedades y estructura de la materia, además, estudia también todos los cambios que tengan que ver con ella por reacciones químicas', 0),
...
(57, 'Lenguaje y Referencia', 'lenguaje.jpg', 'El lenguaje es la capacidad que tiene el ser humano para expresarse y comunicarse, a través de diversos sistemas de signos: orales, escritos o gestuales. La comunicación requiere de este sistema de signos para llegar al objetivo del entendimiento común.', 0),
(58, 'Viajes', 'viajes.jpg', 'Libros sobre viajes, culturas, destinos, mapas e información sobre diferentes países', 1),
(59, 'Gastronomía', 'gastronomia.png', 'Es una práctica que no solo hace énfasis en la preparación de alimentos, sino que también hace énfasis en la relación de estos con los seres humanos, el entorno del cual obtiene dichos alimentos y la forma en la cual los emplea, así como también los aspectos sociales y culturales que intervienen en la relación las sociedades del mundo establecen con su gastronomía.', 0),
(60, 'Historia', 'historia.jpg', 'La historia como ciencia social es la encargada de estudiary relatar los acontecimientos ocurridos en el pasado de la humanidad. También se dice, que es la historia, el período que ha transcurrido desde que se inventó la escritura (llamado año cero) hasta la época actual.', 0);
...
CREATE TABLE `prestamos` (
  ...
  `entregado` int(2) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `usuario` (
  ...
  `Privilegio` varchar(50) COLLATE utf8_spanish2_ci DEFAULT NULL COMMENT 'Tipo de usuario, 0=super, admin, empleado, lector',
...
(40, 'JORGE', '$argon2i$v=19$m=2048,t=4,p=3$TUpwQzZCaDNIM1ZtaUk2SQ$CTVIoQ0HjI6KqSaK6qKo49S4zUwa+mvtvnEXFrVR5q0', 'JORGERODRIGUEZ', 'correoPrueba@hotmail.com', '0', '', 0, 0, ''),
(62, 'JORGEARIEES', '$argon2i$v=19$m=2048,t=4,p=3$akI1Lmh3TlZ5Z3VseFNFaQ$PadEy7t9u9Ajo/JwxOqt8UlEPg7PJeeg9VBFiFLgDbI', 'ARIEES RODRIGUEZ', 'correo1@hotmail.com', 'Empleado', '', 0, 0, ''),
(68, 'LECTOR', '$argon2i$v=19$m=2048,t=4,p=3$RTE4ZExBeEFNVExkSkllOQ$mPsDsRD1ubUEhwEX6sTgrFGbJsgB1ny+ZGEsdmiplq4', 'LECTOR 1', 'lector@hotmail.com', 'Lector', '7d9d7b05eff0b5b2679c3f985b21487c', 1, 0, '');
...
--
ALTER TABLE `prestamos`
  MODIFY `id_prestamo` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
